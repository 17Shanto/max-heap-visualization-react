...
const App = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50">
      <div className="w-full bg-white  shadow-xl border border-slate-200 overflow-hidden">
        ...
        <div className="px-6 py-3 bg-slate-50 border-t border-slate-100 flex justify-between text-xs text-slate-400">
          <span>Scale: 100%</span>
